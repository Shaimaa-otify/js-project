...
.map(employee => `<p>${employee.id}- ${employee.name}, ${employee.age}- ${employee.department} $${employee.salary}</p>`).join("");
...
after done create a seating chart as in working with two-dimentional arrays
*/
